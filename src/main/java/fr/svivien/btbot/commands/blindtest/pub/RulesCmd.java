...
public class RulesCmd extends BTPublicCommand {
    ...
    public void doCommand(CommandEvent event) {
        String rules = ":bulb: **Submissions :** :bulb:\n" +
                       ...
                       "* When the song starts playing, players type their guesses directly in the chat (the player who submitted the song cannot play)\n" +
                       ...
                       "\n" +
                       "The author of the submission can prematurely stop the song by typing the !stop command.\n" +
                       "If any other player wants to skip the song, use the `:skip:` emoji. If more than half of the players uses that emoji, the song is stopped." +
                       "\n" +
